...
2. חזרה סמנטית בין שכבות הפתיחה. אם אותו רעיון מופיע בציטוט הפותח, באמ;לק, בפתיחה ובפרק הראשון — הוא נשאר במקום אחד, והשאר משוכתבים כך שכל שכבה תעשה תפקיד אחר (הציטוט מסקרן; האמ;לק ממפה; הפתיחה מציבה מתח; הפרק הראשון מתחיל להסביר). המבחן: הקורא מתקדם, לא מקבל את אותו מסר בניסוחים משתנים.
