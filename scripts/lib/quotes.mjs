...
- רק אם הושמט מידע/ניואנס, נחתך המשפט, או שונתה המשמעות: "faithful": false, ו-"corrected" = תרגום נאמן ומלא ב**עברית מדוברת וטבעית** (לא מילולית): אחֵד משפטים קטועים, הוסף חלקיקי שיח טבעיים, והשתמש בפועל אידיומטי — כך שישראלי היה אומר זאת בקול.
