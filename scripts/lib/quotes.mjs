...
לכל זוג בדוק: האם ה-"he" משקף את ה-"en" **במלואו ובנאמנות למשמעות**?
תרגום אינו מילולי — מותרת ואף רצויה גמישות לעברית טבעית וזורמת. מה שאסור: לקצר, להשמיט מידע או ניואנס, לחתוך חלקי משפט, או לשנות/להפוך משמעות.

- אם נאמן ומלא במשמעות (גם אם הניסוח חופשי וזורם): "faithful": true. שים לב: תרגום שנשמע "אנגלי" באוזן (שומר על מבנה/מקצב אנגלי) אבל נאמן במשמעות — נשאר faithful:true; אל תפסול אותו על סמך סגנון בלבד.
- רק אם הושמט מידע/ניואנס, נחתך המשפט, או שונתה המשמעות: "faithful": false, ו-"corrected" = תרגום נאמן ומלא ב**עברית מדוברת וטבעית** (לא מילולית): אחֵד משפטים קטועים והשתמש בפועל אידיומטי — כך שישראלי היה אומר זאת בקול. אבל אל תוסיף לציטוט טון, הדגשה או עמדה שאין להם בסיס במקור — טבעיות אינה רישיון להוסיף משמעות.
