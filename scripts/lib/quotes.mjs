...
- אם נאמן ומלא במשמעות (גם אם הניסוח חופשי וזורם): "faithful": true.
- רק אם הושמט מידע/ניואנס, נחתך המשפט, או שונתה המשמעות: "faithful": false, ו-"corrected" = תרגום נאמן ומלא בעברית טבעית.
