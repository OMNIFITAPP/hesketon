...
const DEFAULT_EDITOR_MODEL = 'claude-sonnet-5';
...
- תעתיקים לועזיים מיותרים: החלף במונח העברי המקובל (למשל "באוט"→"מקטע"/"מפגש", "פוקוס"→"מיקוד", "וורבלס"/"הוֶוארבלס"→"מכשירים לבישים/שעונים חכמים", "סטרסור"→"גורם לחץ"). הכלל הכללי: מונח לועזי שאין לו צורה עברית מושרשת — תרגם, אל תשאיר תעתיק פונטי. חריג: מונחים בשימוש יומיומי (פודקאסט) ומונחי-תחום סטנדרטיים בז'אנר (snare, hi-hat, bars).
...
- מילות-מילוי במשורה: "פשוט", "ממש", "בעצם", "כמובן", "למעשה" — השאר רק כשהן נושאות משמעות (כמו "פשוט" שמנוגד ל"מורכב"); אם אפשר להסירן בלי לאבד משמעות — הסר. אל תיגע ב"פשוט" שבתוך ציטוט (תרגום נאמן של just/simply).
