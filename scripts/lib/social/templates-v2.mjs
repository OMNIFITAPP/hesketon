...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .head .logo{font-family:'Rubik','Heebo',sans-serif;font-weight:800;font-size:52px;color:${T.ink};letter-spacing:-1px;text-shadow:0 2px 0 rgba(19,19,33,.24),0 5px 13px rgba(19,19,33,.13);-webkit-text-stroke:1px ${T.ink}}
  ...
  .qtext{font-family:'Rubik','Heebo',sans-serif;font-weight:700;font-size:45px;line-height:1.85;letter-spacing:.2px;color:${T.ink}}
  .qcite{font-family:'Rubik','Heebo',sans-serif;margin-top:34px;font-size:34px;font-weight:700;color:${T.ink}}
  ...
  .kick::before{content:'— '}
  .poster{font-family:'Rubik','Heebo',sans-serif;font-weight:800;letter-spacing:-1.5px;line-height:1.14;text-shadow:0 2px 0 rgba(0,0,0,.09),0 6px 18px rgba(0,0,0,.07)}
  ...
  .bodytxt{font-family:'Rubik','Heebo',sans-serif;font-size:40px;line-height:1.85;color:${T.ink};font-weight:500}
