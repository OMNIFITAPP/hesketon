...
<ul>
<li>לדברי מרטל, רק כ-5% מאוכלוסיית העולם שילמו אי-פעם על גרסה בתשלום של AI — כמעט אף אחד לא באמת משתמש בו, למרות התחושה ההפוכה.</li>
<li>הדרך למאה אלף הדולרים הראשונים: למצוא אנשים עם בעיה, לפתור אותה עם AI, ולמכור את אותו פתרון שוב ושוב — בעיקר למי שמסרב ללמוד את הכלים.</li>
...
<li>העבודות ש"נגמרו" (תכנות, ניתוח פיננסי, ניהול פרויקטים, שירות לקוחות) מפנות מקום לתפקיד חדש: מפעיל סוכנים (agent operator).</li>
...
## אילו עבודות "נגמרו" — ומה בא במקומן
...
**חזון.** לראות עתיד שעדיין אינו קיים. מרטל מביא דוגמה: יזם בודד בנה בתשעה חודשים טכנולוגיה שהפכה לאחת הצומחות המהירות שנודעו, ונמכרה במיליארד דולר — בעוד חברות שגייסו מיליארדים לא ראו אותה מגיעה.

**אכפתיות.** ליישב סכסוך, להבחין בין הערה לבדיחה, לאכפת לאנשים באמת. "קשה למחשבים, קל לבני אדם," הוא חוזר שוב ושוב. זה, לדבריו, היתרון התחרותי שנשאר.

בפועל, מרטל מפעיל AI כמעט בכל שלב: מכלי שממיר דיבור לפקודות, דרך אוטומציות מתוזמנות שמעבדות עבורו את תיבת המייל וההודעות, ועד כתיבת קוד. "ה-AI הוא הטכנולוגיה הראשונה בהיסטוריה שמתוכנתת בשפה האנגלית," הוא אומר — אין צורך ללמוד שפת תכנות, רק לנסח בבירור מה רוצים. הכלל שמנחה אותו הוא "10-80-10": עשרה אחוזים של רעיון (אדם), שמונים אחוזים של ביצוע (היום — AI, לא עובד), ועשרה אחוזים של ליטוש אחרון (אדם). ה"אדם בתוך הלולאה" הזה הוא מה ששומר על האיכות ומונע "זבל של AI".
...
"ה-AI הוא הטכנולוגיה הראשונה בהיסטוריה שמתוכנתת בשפה האנגלית."
