...
references:
  - authors: "Šrámek P, Šimečková M, Janský L, et al."
    ...
    source: "European Journal of Applied Physiology 81(5)"
...
אחד הרעיונות המרתקים בשיחה מגיע מעבודתה של חוקרת נוירוביולוגיה בשם ג'ני גרו מאוניברסיטת דיוק<sup><a class="cite" href="#ref-2">2</a></sup>. לפי המחקר שלה, מחשבות אינן "מתפרצות" מהמוח — הן בנויות בשכבות. כל מחשבה מתחילה מגרעין, מילה, אירוע, ואז המוח מתחיל להוסיף עליה זיכרונות חושיים: מרקם, צבע, ריח, תחושה.
