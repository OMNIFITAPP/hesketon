...
<li>הנרי שוקמן ריפא אקזמה קשה שנים רבות לא על ידי קרם סטרואידים, אלא על ידי התערבות עמוקה יותר: הרגעת מערכת העצבים דרך מדיטציה.</li>
...
שוקמן מסביר שמדיטציה, בניגוד לשאר ההרגלים הבריאותיים, אינה עובדת לפי הלוגיקה הזאת. "הכיוון הכללי שלנו בחיים הוא לנסות לקבל מה שאנחנו רוצים ולהימנע ממה שאנחנו לא רוצים," הוא אומר. "אבל במדיטציה אנחנו פותחים אפשרות אחרת לגמרי — פשוט להיות. יש כבר כאן משהו שצריך רק ליפול לתוך הזרועות שלו."

הפרדוקס שהוא מתאר הוא אמיתי: <mark>אנחנו מקבלים את מה שרצינו כי אנחנו בסדר גם בלי לקבל אותו.</mark> הסבלנות גדלה לא על ידי שנאמן סבלנות, אלא על ידי שנפסיק להתאמץ לקבל תוצאה.
...
הוא ממליץ על שתי טכניקות מעשיות להטמעת ההרגל. הראשונה היא לקבל החלטה פעם אחת ולא לחזור עליה מדי יום — בדיוק כשם שאין מחליטים כל בוקר אם לצחצח שיניים. "קבעו לעצמכם תאריך יעד, חודש למשל, והחלטתם. אתם לא שואלים את עצמכם כל פעם מחדש."
...
> "היחידה מדיטציה רעה היא זו שלא עשית."

אם ישבתם בכוונה להיות שקטים — עשיתם את זה. לא משנה כמה המוח היה עסוק.

## ארבעת ה"אינים": מפה לדרך

בספרו *Original Love* מציע שוקמן מסגרת של ארבעה שלבים — שהוא מכנה "אינים" — המתארים את המרחב שמדיטציה יכולה לפתוח עבורנו.

**מיינדפולנס (תשומת לב)** הוא הבסיס: להיות מודע למחשבות, לרגשות, לתחושות גוף, לצלילים. לא לנתח אותם — רק לשים לב. הדבר הגדול שקורה כאן הוא שינוי במערכת העצבים: ממצב הסימפתטי ("הילחם או ברח") למצב הפאראסימפתטי — מנוחה, עיכול, שקט. שוקמן מספר שכשהחל לתרגל ברצינות, ישן 18 עד 20 שעות בלילה בשבוע הראשון. לא משום שהמדיטציה הייתה מייגעת — אלא משום שלראשונה הבין גופו עד כמה הוא עייף.

**תמיכה** הוא האין השני, ולדעת שוקמן הוא המוזנח ביותר. אנשים רבים מנסים לתרגל לבד, וכשהם נושרים הם סבורים שעליהם לדחוף את עצמם יותר. הפתרון האמיתי הוא שיחת טלפון אחת עם חבר שגם הוא מנסה לתרגל. "פתאום אתה לא לבד בזה, וזה עושה הבדל עצום." תמיכה אינה רק אנשים — היא גם ההכרה שאיננו עצמאיים ומבודדים. כל נשימה היא תמיכה מהאטמוספרה. כל ארוחה היא תמיכה מהאדמה.
...
## כשהחיים מרגישים לא נכון — זה מידע
...
- **חמש דקות זה מספיק, ועקביות עדיפה על משך.** אל תחכו ל"זמן הנכון" לתרגל. קבלו החלטה פעם אחת, עגנו אותה ליד פעולה קיימת, ותנו לה להפוך להרגל כמו צחצוח שיניים.
- **אל תתרגלו לבד.** שיחת טלפון אחת עם מישהו שגם הוא מנסה תועיל יותר מכל מאמץ פנימי. תמיכה היא חלק מהתרגול, לא תוספת אופציונלית.
