...
"אם אתם נוסעים בכביש ורואים פרה — למי אכפת?... אבל אם אתם נוסעים ורואים פרה סגולה, אתם תחשבו על זה: למה הפרה הזאת הייתה סגולה? וזה יישאר לכם בראש."
...
- היקף — **שימו לב ליחס, לא רק למספרים** (חוק 3א/9):
  המקור טוען קשר סיבתי, לא שקילות:
    12 מיליארד צפיות (90 יום, ערוץ ראשי)
      ← מתוכן ~8% הם בני אדם שונים
        ← ומכאן ~850 מיליון אנשים ייחודיים.
  ⇐ "we did around 12 billion views in the last 90 days on just the main channel. And of those
     12 billion views, like whatever 8% of them are different humans. So, it's like factually
     like 850 million. Like when I say that, people are like, 'Oh, that's 850 million views.'"
  ⇐ "around 850 million unique people have watched a video in the last quarter"
  ⚠️ הדובר עצמו מזהיר מפני אי-הבנה: אנשים שומעים "850 מיליון" ומבינים "צפיות". לפי חוק 6א
     התיקון הזה הוא חלק מהעובדה וחייב להופיע בפוסט.
     [גרסה קודמת הצמידה את שני הנתונים במקף ("850 מיליון בני אדם — 12 מיליארד צפיות"),
      כלומר שיחזרה בדיוק את אי-ההבנה שהדובר הזהיר מפניה. תוקן ביולי 2026. הבלוק הזה עצמו
      רשם קודם שלושה אטומים מופרדים בנקודה-פסיק בלי ה-8% — ולכן האימות לא יכול היה לתפוס.]
  "around four billion views a month" — לא נכנס לפוסט (חוק 3ב: מספר אחד נושא-משקל לפסקה).
- בן 28 ("28"); "I started making videos when I was 11." — הועברו לפתיח כהקשר ביוגרפי,
  לא כחלק מפסקת ההיקף שאליה לא היו שייכים.
